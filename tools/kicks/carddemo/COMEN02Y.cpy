      ...
      * tools/kicks: upstream declares OCCURS 12 over 11 entries; MVT
      * COBOL flags the short REDEFINES object with a C-level RC=8, so a
      * 12th empty slot pads the table to the declared size.
           10 FILLER                       PIC 9(02) VALUE 12.
           10 FILLER                       PIC X(35) VALUE SPACES.
           10 FILLER                       PIC X(08) VALUE 'DUMMY   '.
           10 FILLER                       PIC X(01) VALUE 'U'.
